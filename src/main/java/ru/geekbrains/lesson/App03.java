...
public class App03 {
    ...
    public static void main(String[] args) {
        // Важной особенностью дженериков является то, что они инвариантны (в отличие от
        // массивов, которые ковариантны

        // Ковариантность массивов
        String[] strings = new String[2];
        Object[] objects = strings;  // valid, String[] is Object[] // массивы ковариантны
        objects[0] = 12; // Без проблем компилируется, но возникает ошибка времени выполнения

        // в отличие от массивов дженерики инвариантны
        List<String> stringList = new ArrayList<>(); // дженерики инвариантны
//        List<Object> objectList = stringList;  // ошибка времени компиляции
//        objectList.add(12);
        // То есть, в данном случае можно сказать, что "полиморфизм не работает" -
        // мы не можем приравнять коллекцию с наследниками к коллекции с родителями
...
//        app03.feedAnimals(snakes); // ошибка, т.к. Collection<Animal> != Collection<Snake>
        ...
        // Параметризовать можно не только классом, но и интерфейсом
