...
//        if (a > b) {} // error!
        ...
        // Если мы посмотрим, какие еще классы унаследованы от этого интерфейса, то обнаружим там
        // числовые типы, даты, и много чего еще
        ...
        // А что делать, если нам достался класс, который не наследуется от интерфейса Comparable,
        // или же мы хотим отсортировать как-то по особому?
